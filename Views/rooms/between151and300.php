          ...
          <?php $last = 0; for($i=0;$i< $rows ;$i++){ ?>
            <div class=' flex flex-row justify-center'>
              ...
              <?php }else{
                ...
                <input name='seats[]' id='inputSeat' type='checkbox'
                class='border-2 absolute h-2 w-2 cursor-pointer ' 
                <?php if($occupied){echo 'disabled';} ?> 
                value='<?php echo $letters[$i] ?>-<?php echo $j ?>'

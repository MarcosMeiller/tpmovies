<?php namespace admin;?> 
    <aside class="relative bg-blue-800 h-screen w-1/5 hidden sm:block shadow-xl">
        <div class="flex items-center h-16 border-b-2 border-gray-500 px-6">
            <a href="index.html" class="text-white md:text-md lg:text-xl font-bold hover:text-gray-300">MOVIEPASS Admin</a>
        </div>
        <nav class="text-white text-base font-semibold">
            <a href="index.html" class="flex items-center bg-blue-900 text-white py-4 pl-6 nav-item hover:bg-blue-900">
			<i class="fas fa-film mr-3"></i>
                Peliculas
            </a>
            <a href="<?php echo FRONT_ROOT ?>Cinema/ViewCinemas" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item hover:bg-blue-900">

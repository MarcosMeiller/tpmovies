...
<div class='flex'>
    ...
    <div class="relative w-full flex flex-col h-screen">
      ...
      <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        ...
        <div class='bg-blue-900 my-2 py-2 pr-2 flex flex-col md:flex-row justify-end items-center'>
          <?php require 'forms/formFilterMovies.php' ?>
        </div>
...
<?php if($moviesList) { ?>
  <div class='min-w-full min-h-full w-full '>
    ...
    <?php   foreach($moviesList as $movie){ ?>
      <div class='card rounded-lg bg-blue-900 relative'>
 ...
 <div class='flex flex-col md:flex-row items-center justify-center md:justify-around my-2 relative mb-0'>
        <div class=''>

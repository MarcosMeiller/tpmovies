...
<div class="w-full bg-blue-900">
  ...
  <div  x-data="{ open: false }" class="flex flex-col max-w-screen px-5 lg:px-10 xl:px-20 py-2 mx-auto lg:items-center lg:justify-between lg:flex-row">
      ...
      <div class='flex flex-row items-center justify-between' >  
        ...
        <button class="text-white inline-flex p-3 hover:bg-gray-900 rounded lg:hidden ml-auto hover:text-white outline-none flex " type='button' @click="open = !open">
        ...
        <nav :class="open ? 'flex' : 'hidden'" class="text-center flex flex-col flex-grow lg:items-center lg:pb-0 lg:flex lg:flex-row">
          ...
          <?php if($user){ ?>  
                ...
                <button @click="open = !open" class="hidden md:flex flex-row text-gray-900 bg-gray-200 items-center px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent rounded-lg md:mt-0 md:ml-4  focus:text-gray-900 hover:bg-gray-200 focus:outline-none">
        ...
        <?php }else{ ?>
          ...
          <div class='flex-col flex lg:flex-row lg:flex-grow'></div>

              <div class='flex flex-col md:justify-end lg:flex-row text-center items-center px-5 lg:px-0 border-0 border-t-2 lg:border-t-0 my-2 mx-8 lg:my-0 lg:mx-0 '>
